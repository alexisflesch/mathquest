import{_ as n,c as a,a as e,o as l}from"./app-DoDG4mLI.js";const p={};function i(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="deploiement-et-devops" tabindex="-1"><a class="header-anchor" href="#deploiement-et-devops"><span>Déploiement et DevOps</span></a></h1><h2 id="vue-d-ensemble" tabindex="-1"><a class="header-anchor" href="#vue-d-ensemble"><span>Vue d&#39;ensemble</span></a></h2><p>MathQuest peut être déployé sur différents environnements : développement local, serveur VPS, ou infrastructure cloud. Le déploiement utilise PM2 pour la gestion des processus et inclut des optimisations pour les environnements à mémoire limitée.</p><h2 id="prerequis-systeme" tabindex="-1"><a class="header-anchor" href="#prerequis-systeme"><span>Prérequis système</span></a></h2><h3 id="configuration-minimale" tabindex="-1"><a class="header-anchor" href="#configuration-minimale"><span>Configuration minimale</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># Ubuntu/Debian</span></span>
