...
- main:
  ...
  - paragraph: Bonjour meyzie 👋, ravi de vous revoir !
  - paragraph: "Utilisez le menu à gauche pour naviguer dans l'application. Vous pouvez :"
  - list:
    - listitem:
      - strong: Gérer vos activités existantes
      - text: ": gérer vos sessions et tournois existants"
    - listitem:
      - strong: Créer de nouvelles activités
      - text: ": préparer de nouveaux quiz ou tournois pour vos élèves en piochant dans la base de données"
  ...
  - text: le service peut être interrompu pour mise à jour.
```
