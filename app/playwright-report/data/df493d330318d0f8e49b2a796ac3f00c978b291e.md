...
- main:
  - img "MathQuest logo"
  - heading "Mathquest" [level=1]
  - paragraph: 🧠 Une alternative libre à Kahoot avec une base de questions partagée.
  - paragraph: • Créez vos quiz personnalisés en utilisant la base de questions partagée
  - paragraph: • Animez vos cours en temps réel avec scores et classements
  - paragraph: • Jouez en solo ou en mode multi-joueurs
  - paragraph: • Support natif de LaTeX pour les formules mathématiques
  - paragraph: "Pour en savoir plus :"
  - link "📖 Documentation":
    - /url: https://alexisflesch.github.io/mathquest/
  - link "💻 Code source":
    - /url: https://github.com/alexisflesch/mathquest
  - strong: "⚠️ En développement :"
  - text: certaines fonctionnalités peuvent manquer et le service être interrompu pour mise à jour. Auto-hébergez l'application si possible.
```
