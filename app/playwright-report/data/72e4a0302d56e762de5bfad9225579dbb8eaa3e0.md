...
- Name: Game Joining Bug Reproduction >> reproduces user reported issue - join with invalid userId
- Location: /home/aflesch/mathquest/app/tests/e2e/game-joining-bug.spec.ts:107:9
...
Call log:
  - waiting for locator('input[placeholder*="pseudo"]') to be visible
    ...
    at /home/aflesch/mathquest/app/tests/e2e/game-joining-bug.spec.ts:109:9
```
