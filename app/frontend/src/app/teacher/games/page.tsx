...
function ActivityCard({ template, expanded, onToggle, onStartActivity, onDuplicate, onDelete, formatDate, gameInstances, onFetchGameInstances }: ActivityCardProps) {
    ...
    return (
        <>
            <div className="bg-[color:var(--card)] rounded-lg border border-[color:var(--border)] hover:border-[color:var(--muted-foreground)] transition-colors">
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2 ml-4">
                            <button
                                ...
                                className="btn-primary text-sm px-3 py-2 flex items-center gap-2 whitespace-nowrap"
                            >
                                <Play size={16} />
                                Lancer
                            </button>
                ...
                <AnimatePresence initial={false}>
                    {expanded && (
                        <motion.div
                            ...
                            className="border-t border-[color:var(--border)] bg-[color:var(--muted)] overflow-hidden"
                        >
                            <div className="p-3 sm:p-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-2 px-3 py-2 text-sm text-[color:var(--muted-foreground)] hover:text-[color:var(--foreground)] transition-colors"
                                    >
                                        <Edit2 size={16} />
                                        Éditer
                                    </Link>
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 px-3 py-2 text-sm text-[color:var(--alert)] hover:text-[color:var(--alert)] hover:opacity-80 transition-colors"
                                    >
                                        <Trash2 size={16} />
                                        Supprimer
                                    </button>
...
export default function TeacherGamesPage() {
    ...
    const fetchGameInstances = async (templateId: string) => {
        try {
            console.log('Fetching game instances for template:', templateId);
    ...
    return (
        <div className="min-h-screen bg-background">
            {/* Header */}
            <div className="sticky top-0 z-10 bg-background border-b border-[color:var(--border)] px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid gap-3 sm:gap-4">
                        {games.map((template) => (
                            <ActivityCard
                                key={template.id}
                                template={template}
                                expanded={expandedGameId === template.id}
