...
const logger = (0, logger_1.default)('ResumeQuizHandler');
function handleResume(io, socket, prisma, { quizId, teacherId, tournamentCode }) {
    ...
    let timeLeft = null;
    if (code && tournamentState_1.tournamentState[code] && tournamentState_1.tournamentState[code].pausedRemainingTime > 0) {
        ...
        quizState_1.quizState[quizId].chrono.timeLeft = timeLeft;
    ...
    quizState_1.quizState[quizId] = (0, quizUtils_1.updateChrono)(quizState_1.quizState[quizId], timeLeft, 'play');
    ...
    (0, quizUtils_1.emitQuizTimerUpdate)(io, quizId, 'play', currentQuestionUid, timeLeft);
    ...
    if (code) {
        ...
        (0, tournamentTriggers_1.triggerTournamentTimerSet)(io, code, timeLeft, 'running'); // MODIFIED
    }
    else {
