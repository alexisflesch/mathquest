 ...
 */
export function sendQuestionToTournament(io, quizId, questionId) {
    if (!quizState[quizId]) {
 ...
 */
export function triggerQuizTimerAction(io, quizId, questionId, action, timeLeft) {
 ...
 */
export function triggerQuizSetTimer(io, quizId, questionId, timeLeft) {
    const timer = getQuestionTimer(quizId, questionId);
    if (timer) {
