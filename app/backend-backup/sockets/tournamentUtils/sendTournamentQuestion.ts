...
interface FilteredQuestionData {
    defaultMode: string | undefined; // Allow type to be undefined
    uid: string;
...
function createFilteredQuestionData(payload: TournamentQuestionPayload): FilteredQuestionData {
    ...
    return {
        defaultMode: question.defaultMode, // No change needed here as FilteredQuestionData now allows undefined
        uid: question.uid,
...
function legacySendTournamentQuestion(
    ...
    const filteredPayload: FilteredQuestionData = {
        defaultMode: questionObj.defaultMode, // No change needed here
        uid: questionObj.uid,
