...
import { registerGameHandlers, gameState } from '@sockets/gameHandler';
import { registerQuizTemplateDashboardHandlers, quizState } from '@sockets/quizHandler';
...
const httpServer = createServer((req, res) => {
    ...
    // API endpoint to get active games/quizzes count
    if (req.url === '/api/stats') {
        ...
        res.end(JSON.stringify({
            activeGames: Object.keys(gameState).length,
