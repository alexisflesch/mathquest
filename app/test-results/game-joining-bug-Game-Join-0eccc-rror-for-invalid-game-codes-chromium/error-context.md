...
- Name: Game Joining Bug Reproduction >> join page shows appropriate error for invalid game codes
- Location: /home/aflesch/mathquest/app/tests/e2e/game-joining-bug.spec.ts:136:9
...
Call log:
  - waiting for locator('input[placeholder*="pseudo"]') to be visible
    ...
    at /home/aflesch/mathquest/app/tests/e2e/game-joining-bug.spec.ts:138:9
```
