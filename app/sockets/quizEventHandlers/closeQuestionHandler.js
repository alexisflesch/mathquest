/**
 * closeQuestionHandler.js - JavaScript bridge to TypeScript handler
 * 
...
try {
    ...
    module.exports = require('./closeQuestionHandler.ts').default;
} catch (e) {
    ...
    module.exports = require('./closeQuestionHandler.legacy.js');
}
