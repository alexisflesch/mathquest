...
import { tournamentState } from './tournamentState'; // Changed to ES6 import, assuming tournamentState.ts is the source or has a bridge
import { sendTournamentQuestion } from './sendTournamentQuestion'; // Changed to ES6 import, assuming .ts or bridge
import { calculateScore, saveParticipantScore } from './scoreUtils'; // Changed to ES6 import, assuming .ts or bridge
import prisma from '../../db'; // Changed to ES6 import
