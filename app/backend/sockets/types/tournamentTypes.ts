...
import {
    ...
    TournamentParticipant as BaseTournamentParticipant,
    TournamentAnswer as BaseTournamentAnswer,
...
import {
    ...
    TournamentState as BaseTournamentState,
    TournamentStateContainer as BaseTournamentStateContainer
} from '@shared/types/tournament/state';

// Re-export all the shared tournament types
