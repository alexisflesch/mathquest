...
export function calculateScore(
    ...
    if (typeof answer.isCorrect !== 'boolean') {
        ...
        const correctAnswerDetails = question.reponses?.find(r => r.correct);
        if (question.type === 'QCM' || question.type === 'QCU') {
            answer.isCorrect = correctAnswerDetails?.texte === answer.value;
            ...
            answer.isCorrect = correctAnswerDetails?.texte === String(answer.value);
        } else {
    ...
    logger.debug(
        `[calculateScore] Q: ${question.uid}, AnswerVal: ${answer.value}, Correct: ${answer.isCorrect}, ` +
