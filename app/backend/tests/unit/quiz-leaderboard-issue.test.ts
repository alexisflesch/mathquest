...
import { runGameFlow, GameFlowOptions } from '../../src/sockets/handlers/sharedGameFlow';
import { calculateLeaderboard } from '../../src/sockets/handlers/sharedLeaderboard';
import { emitLeaderboardFromSnapshot } from '../../src/core/services/gameParticipant/leaderboardSnapshotService';
...
describe('Quiz Leaderboard Update Issue Reproduction', () => {
    ...
    describe('Quiz Mode Leaderboard Behavior', () => {
        it.skip('should NOT emit leaderboard updates automatically after question ends in quiz mode', async () => {
            ...
            (io.to as any) = jest.fn().mockReturnValue({ emit: mockEmit });
    ...
    describe('Tournament Mode Leaderboard Behavior', () => {
        it('should emit leaderboard updates automatically after question ends in tournament mode', async () => {
            ...
            const { initLeaderboardSnapshot, setLeaderboardSnapshot, emitLeaderboardFromSnapshot } = await import('../../src/core/services/gameParticipant/leaderboardSnapshotService');
    ...
    describe('Timer Expiry Edge Cases', () => {
        it('should not trigger leaderboard updates on timer expiry in quiz mode', async () => {
            ...
            const { CanonicalTimerService } = await import('../../src/core/services/canonicalTimerService');
