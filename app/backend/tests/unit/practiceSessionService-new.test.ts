...
// @ts-ignore - Jest module mapping handles this path
...
describe('Practice Session Service - Core Functionality', () => {
    ...
    describe('Session Creation', () => {
        ...
        it('should generate unique session IDs', async () => {
            ...
            const session1 = await practiceSessionService.createSession(userId, settings);
            const session2 = await practiceSessionService.createSession(userId, settings);
    ...
    describe('Session State Management', () => {
        it('should handle session storage correctly', async () => {
            ...
            await practiceSessionService.createSession(userId, settings);
