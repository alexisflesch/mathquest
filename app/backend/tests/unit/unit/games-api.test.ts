...
jest.mock('../../../src/core/services/gameParticipant/joinService', () => ({
    joinGame: jest.fn()
}));
...
import { GameInstanceService } from '../../../src/core/services/gameInstanceService';
import { GameParticipantService } from '../../../src/core/services/gameParticipantService';
import { __setGameInstanceServiceForTesting, __setGameParticipantServiceForTesting } from '../../../src/api/v1/games';
