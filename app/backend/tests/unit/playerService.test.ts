...
describe('PlayerService', () => {
    ...
    describe('registerPlayer', () => {
        it('should register an anonymous player (without password)', async () => {
            ...
            (prisma.player.create as jest.Mock).mockResolvedValueOnce({
                id: 'player-uuid',
                username: 'testplayer',
        ...
        it('should throw an error if player with username already exists', async () => {
            ...
            (prisma.player.findUnique as jest.Mock).mockResolvedValueOnce({
    ...
    describe('getPlayerByCookieId', () => {
        it('should return a player when found by cookieId', async () => {
            ...
            (prisma.player.findUnique as jest.Mock).mockResolvedValueOnce(mockPlayer);
