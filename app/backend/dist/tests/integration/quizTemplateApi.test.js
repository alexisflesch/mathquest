...
const gameTemplates_1 = require("@/api/v1/gameTemplates");
...
describe('gameTemplate API Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        (0, gameTemplates_1.__setgameTemplateServiceForTesting)(mockgameTemplateService);
    });
    beforeEach(() => {
    ...
    describe('DELETE /api/v1/game-templates/:id', () => {
        it('should delete a quiz template successfully', async () => {
            mockgameTemplateService.deletegameTemplate.mockResolvedValue({ success: true });
            const response = await (0, supertest_1.default)(server_1.app)
