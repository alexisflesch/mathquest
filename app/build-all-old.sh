...
# Builds in place, then atomically moves output to staging and replaces
...
main() {
    ...
    # Build frontend in temp directory
    build_frontend_temp
    
    # Build backend in temp directory
    build_backend_temp
    
    # Verify both temp builds
    verify_temp_builds
    
    # If we get here, builds were successful - perform atomic replacement
    atomic_replace
